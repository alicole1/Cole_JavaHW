...
public class Demo {
    public static void main(String[] args) {
        ...
        System.out.print("Enter the row you want the lawnmower to start with (1 being top of the lawn) ");
        int lmStartRow = in.nextInt();
        System.out.print("Enter the column you want the lawnmower to start with (1 being left of the lawn) ");
        int lmStartColumn = in.nextInt();
        System.out.print("What direction do you want the lawnmower to go? (l)eft, (r)ight, (u)p, or (d)own? ");
